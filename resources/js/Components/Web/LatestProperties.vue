<script setup>
import Property from '@/Components/Web/Property.vue';
...
<template>
    <section class="container px-6 py-12 mx-auto">
        <div class=" text-center">
            <h2 class="mb-4 text-2xl font-extrabold leading-none tracking-tight text-primary-web-700 md:text-3xl lg:text-4xl dark:text-white">Últimos inmuebles</h2>
