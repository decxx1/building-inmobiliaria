        ...
        <div :class="[sidebarCompact ? 'sm:ml-20' : 'sm:ml-64','px-3 py-1 lg:px-5 lg:pl-3 transition-all ease-in duration-300']">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-white dark:hover:bg-background-dark dark:focus:ring-background-dark">
                        <span class="w-7 h-7 icon-[heroicons--bars-3-bottom-left-solid]"></span>
                    </button>
                    <!-- Botón de compactar sidebar -->
                    <button @click="toggleSidebar" type="button" class="hidden p-2 text-sm text-gray-500 rounded-lg sm:block hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-200 dark:hover:text-white dark:hover:bg-background-dark dark:focus:ring-background-dark">
                        <span class="w-7 h-7 icon-[heroicons--bars-3-bottom-left-solid]"></span>
                    </button>
                </div>
